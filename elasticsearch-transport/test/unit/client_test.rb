...
class Stretchysearch::Transport::ClientTest < Test::Unit::TestCase
  ...
  context "Client" do
    setup do
      Stretchysearch::Transport::Client::DEFAULT_TRANSPORT_CLASS.any_instance.stubs(:__build_connections)
      @client = Stretchysearch::Transport::Client.new
    end

    should "be aliased as Stretchysearch::Client" do
      assert_nothing_raised do
        assert_instance_of(Stretchysearch::Transport::Client, Stretchysearch::Client.new)
      end
    end

    should "have default transport" do
      assert_instance_of Stretchysearch::Transport::Client::DEFAULT_TRANSPORT_CLASS, @client.transport
    end

    should "instantiate custom transport class" do
      client = Stretchysearch::Transport::Client.new :transport_class => DummyTransport
      assert_instance_of DummyTransport, client.transport
    end

    should "take custom transport instance" do
      client = Stretchysearch::Transport::Client.new :transport => DummyTransport.new
      assert_instance_of DummyTransport, client.transport
    end
    ...
    should "send GET request as POST with the send_get_body_as option" do
      ...
      client = Stretchysearch::Transport::Client.new :transport => transport, :send_get_body_as => 'POST'
    ...
    should "pass options to the transport" do
      client = Stretchysearch::Transport::Client.new :transport_options => { :foo => 'bar' }
      assert_equal 'bar', client.transport.options[:transport_options][:foo]
    end

    should "merge request_timeout to the transport options" do
      client = Stretchysearch::Transport::Client.new :request_timeout => 120
    ...
    context "when passed hosts" do
      should "have localhost by default" do
        c = Stretchysearch::Transport::Client.new
        assert_equal 'localhost', c.transport.hosts.first[:host]
      end

      should "take :hosts, :host, :url or :urls" do
        c1 = Stretchysearch::Transport::Client.new :hosts => ['foobar']
        c2 = Stretchysearch::Transport::Client.new :host  => 'foobar'
        c3 = Stretchysearch::Transport::Client.new :url   => 'foobar'
        c4 = Stretchysearch::Transport::Client.new :urls  => 'foo,bar'
    ...
    context "detecting adapter for Faraday" do
      setup do
        Stretchysearch::Transport::Client::DEFAULT_TRANSPORT_CLASS.any_instance.unstub(:__build_connections)
      ...
      should "use the adapter from arguments" do
        c = Stretchysearch::Transport::Client.new :adapter => :typhoeus
        handlers = c.transport.connections.all.first.connection.builder.handlers
    ...
    context "configuring Faraday" do
      ...
      should "apply faraday adapter" do
        c = Stretchysearch::Transport::Client.new do |faraday|
    ...
    context "when passed options" do
      ...
      should "transfer selected host parts from URL into the 'http' options" do
        c = Stretchysearch::Transport::Client.new :url => 'https://U:P@node1:8080'
