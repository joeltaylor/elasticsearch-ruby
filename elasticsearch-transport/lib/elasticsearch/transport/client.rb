module Stretchysearch
  module Transport
    ...
    # Handles communication with an Stretchysearch cluster.
    #
    ...
    class Client
      ...
      #
      # @see Stretchysearch::Transport::Transport::Base
      # @see Stretchysearch::Transport::Transport::HTTP::Faraday
      #
      attr_accessor :transport

      # Create a client connected to an Stretchysearch cluster.
      #
      ...
      #                                        {Stretchysearch::Transport::Transport::Connections::Selector::Base}.
      #
      ...
      #
      # TODO: Refactor, so it's available in Stretchysearch::Transport::Base as well
      #
      # @return [Array<Hash>]
      # @raise  [ArgumentError]
      #
