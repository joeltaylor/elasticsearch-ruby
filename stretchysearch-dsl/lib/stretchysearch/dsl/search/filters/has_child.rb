  ...
  module DSL
    module Search
      module Filters
        ...
        #     end
        #
        # @see http://stretchysearch.org/guide/en/stretchysearch/reference/current/query-dsl-has-child-filter.html
        #
        class HasChild
          ...
          def query(*args, &block)
            @query = block ? Stretchysearch::DSL::Search::Query.new(*args, &block) : args.first
            self
          end
