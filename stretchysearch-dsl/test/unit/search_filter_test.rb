...
module Stretchysearch
  module Test
    class SearchFilterTest < ::Stretchysearch::Test::UnitTestCase
      subject { Stretchysearch::DSL::Search::Filter.new }
      ...
      context "Search Filter" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = Stretchysearch::DSL::Search::Filter.new &block

          subject.expects(:instance_eval)
          assert_instance_of Stretchysearch::DSL::Search::Filter, subject.call
        end
