...
module Stretchysearch
  module Test
    class BaseComponentTest < ::Stretchysearch::Test::UnitTestCase
      context "BaseComponent" do

        class DummyComponent
          include Stretchysearch::DSL::Search::BaseComponent
        end
        ...
        class DummyCompoundFilter
          include Stretchysearch::DSL::Search::BaseCompoundFilterComponent
        end
