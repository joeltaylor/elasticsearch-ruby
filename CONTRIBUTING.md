The process for contributing to any of the [Stretchysearch](https://github.com/stretchysearch) repositories is similar:
...
Please make sure you have signed the [Contributor License Agreement](http://www.stretchysearch.org/contributor-agreement/). We are not asking you to assign copyright to us, but to give us the right to distribute your code without restriction. We ask this of all contributors in order to assure our users of the origin and continuing existence of the code. You only need to sign the CLA once.
