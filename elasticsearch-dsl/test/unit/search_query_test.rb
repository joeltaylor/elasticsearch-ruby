...
module Stretchysearch
  module Test
    class SearchQueryTest < ::Stretchysearch::Test::UnitTestCase
      subject { Stretchysearch::DSL::Search::Query.new }
      ...
      context "Search Query" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = Stretchysearch::DSL::Search::Query.new &block

          subject.expects(:instance_eval)
          assert_instance_of Stretchysearch::DSL::Search::Query, subject.call
        end
