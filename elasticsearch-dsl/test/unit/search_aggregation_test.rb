...
module Stretchysearch
  module Test
    class SearchAggregationTest < ::Stretchysearch::Test::UnitTestCase
      subject { Stretchysearch::DSL::Search::Aggregation.new }
      ...
      context "Search Aggregation" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = Stretchysearch::DSL::Search::Aggregation.new &block

          subject.expects(:instance_eval)
          assert_instance_of Stretchysearch::DSL::Search::Aggregation, subject.call
        end
