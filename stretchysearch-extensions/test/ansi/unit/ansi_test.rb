  ...
  context "The ANSI extension" do
    setup do
      ...
      @client.stubs(:perform_request).returns \
        Stretchysearch::Transport::Transport::Response.new(200, { "ok" => true, "status" => 200, "name" => "Hit-Maker",
    ...
    should "wrap the response" do
      ...
      assert_instance_of Stretchysearch::Extensions::ANSI::ResponseBody, response
    ...
    should "call the 'awesome_inspect' method when available and no handler found" do
      @client.stubs(:perform_request).returns \
        Stretchysearch::Transport::Transport::Response.new(200, {"index-1"=>{"aliases"=>{}}})
