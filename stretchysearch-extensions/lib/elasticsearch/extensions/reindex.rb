  ...
  module Extensions
    ...
    module Reindex
      ...
      module API
        ...
        #
        # This method will be mixed into the Stretchysearch client's API, if available.
        #
      ...
      Stretchysearch::API::Actions.__send__ :include, API if defined?(Stretchysearch::API::Actions)
      Stretchysearch::Transport::Client.__send__ :include, API if defined?(Stretchysearch::Transport::Client) && defined?(Stretchysearch::API)
      ...
      #
      #     source_client  = Stretchysearch::Client.new url: 'http://localhost:9200'
      #     target_client  = Stretchysearch::Client.new url: 'http://localhost:9250'
      #
      #     reindex = Stretchysearch::Extensions::Reindex.new \
