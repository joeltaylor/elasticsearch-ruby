...
module Backup
  module Database
    ...
    #
    # This extension allows to backup Stretchysearch indices as flat JSON files on the disk.
    #
    ...
    class Stretchysearch < Base
      ...
      def client
        @client ||= ::Stretchysearch::Client.new url: url, logger: logger
      end
...
::Backup::Config::DSL::Stretchysearch = ::Backup::Database::Stretchysearch
