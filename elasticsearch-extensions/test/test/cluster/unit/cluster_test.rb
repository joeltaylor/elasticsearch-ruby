  ...
  context "The Test::Cluster" do
    context "module" do
      should "delegate the methods to the class" do
        ...
        Stretchysearch::Extensions::Test::Cluster.start foo: 'bar'
        Stretchysearch::Extensions::Test::Cluster.stop foo: 'bar'
        Stretchysearch::Extensions::Test::Cluster.running? foo: 'bar'
        Stretchysearch::Extensions::Test::Cluster.wait_for_green foo: 'bar'
      end
    end

    context "class" do
      setup do
        Stretchysearch::Extensions::Test::Cluster::Cluster.any_instance.stubs(:__default_network_host).returns('_local_')

        @subject = Stretchysearch::Extensions::Test::Cluster::Cluster.new(number_of_nodes: 1)
