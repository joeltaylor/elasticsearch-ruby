  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @note The flush operation is handled automatically by Stretchysearch, you don't need to perform it manually.
        #
        ...
        #
        # @see http://www.stretchysearch.org/guide/reference/api/admin-indices-flush/
        #
        def flush(arguments={})
          valid_params = [
            :force,
