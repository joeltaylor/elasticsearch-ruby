...
module Stretchysearch
  ...
  module API
    module Utils
      ...
      # Parses the Stretchysearch source code and returns a Hash of REST API information/specs.
      #
      # Example:
      #
      #     {
    ...
    # Contains a generator which will parse the Stretchysearch *.java source files,
    ...
    class JsonGenerator < Thor
      ...
      #
      desc "generate", "Generate JSON API spec files from Stretchysearch source code"
